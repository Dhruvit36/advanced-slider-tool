...
interface EasingButtonSelectorProps {
  value: string;
...
export function EasingButtonSelector({ 
  value, 
  onChange, 
  variant = 'default',
  compact = false
}: EasingButtonSelectorProps) {
  const easingOptions: EasingButtonOption[] = [
    { 
      value: 'ease', 
      label: 'Ease', 
...
export default EasingButtonSelector;
